...
let temp = document.querySelector("section.converter-container input[type='text']");
...
if (document.getElementById("fahrenheit_to_celsius").addEventListener("click", tempToCelsius)) {
    tempToCelsius(temp);
};

if (document.getElementById("celsius_to_fahrenheit").addEventListener("click", tempToFahrenheit)) {
