...
function fahrenheit_to_celsius (temperature, metric) {
...
fahrenheit_to_celsius(76, 'fahrenheit');
fahrenheit_to_celsius(50, 'fahrenheit');
fahrenheit_to_celsius(101, 'fahrenheit');

function celsiusToF (temp, metric) {
	if (metric === 'celsius') {
		console.log(temp + 32 * 1.8);
	} else {
	   console.log(temp);
...
celsiusToF(76, 'celsius');
celsiusToF(50, 'celsius');
celsiusToF(101, 'celsius');
