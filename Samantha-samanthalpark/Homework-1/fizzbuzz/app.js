...
/* Note from Samantha: Shifted the 'else if' for 'fizzbuzz' as the first condition.
Otherwise it would read the 'fizz' and 'buzz' conditions first and skip 'fizzbuzz' entirely.*/
