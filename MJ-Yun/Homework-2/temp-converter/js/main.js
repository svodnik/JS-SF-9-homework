...
console.log("78 Degrees Farenheit is equivalent to " + convertC(78) + " degrees Celcius");


function convertF(temp){
  return (temp - 32) / 1.8;
 }
 console.log("25 Degrees Celcius is equivalent to " + convertF(25) + " degrees Farenheit");




 document.getElementById("fahrenheit_to_celsius").addEventListener("click", function(){
   document.getElementById('result').innerHTML=(convertF(document.getElementById('temperature').value));
 });

 document.getElementById("celsius_to_fahrenheit").addEventListener("click", function(){
   document.getElementById('result').innerHTML=(convertC(document.getElementById('temperature').value));
 });
